...
# the following commands are used to run functions to compute polygenic scores, precision metrics (mse and r) and the number of lost / conserved QTLs per evolutionary scenario
library(vcfR)
library(stringr)
library(hash)
library(tidyr)
